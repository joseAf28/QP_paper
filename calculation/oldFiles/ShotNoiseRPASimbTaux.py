...
def greenLeadsKeldysh(omega, couplingValue, voltageValue, beta = 1e5):
    return -1j*couplingValue*np.tanh(0.5*beta*(omega - voltageValue/2.0))
    # return -1j*couplingValue*np.tanh(0.5*beta*(omega - voltageValue/2.0))
...
def greenKeldysh(epsilon, omega, lambdaValue, phiValue, voltageValue, couplingValue, beta=1e5):
...
def gK_GK(epsilon, omega, lambdaValue, phiValue, voltageValue, couplingValue, Tvalue):
    ...
    beta = 1.0/Tvalue
    gK = lambda omega: greenLeadsKeldysh(omega, couplingValue, voltageValue, beta)
    GK = lambda omega: greenKeldysh(epsilon, omega, lambdaValue, phiValue, voltageValue, couplingValue, beta)
    ...
    SintReal = scipy.integrate.quad(lambda nu1: Sintegrand(nu1, omega).real, -np.inf, np.inf, limit=1000)
    SintImag = scipy.integrate.quad(lambda nu1: Sintegrand(nu1, omega).imag, -np.inf, np.inf, limit=1000)
...
def KeldyshNonIntOrder2(epsilon, omega, lambdaValue, phiValue, voltageValue, couplingValue, Tvalue):
    ...
    Sintegrand = lambda nu, omega: Sintegrand2(nu, omega) + Sintegrand2(nu, -omega) - Sintegrand3(nu, omega) - Sintegrand4(nu, omega)
...
def RetardedNonIntOrder2(epsilon, omega, lambdaValue, phiValue, voltageValue, couplingValue, Tvalue):
    ...
    Sintegrand = lambda nu, omega: Sintegrand2(nu, omega) + Sintegrand2_2(nu, omega) - Sintegrand3(nu, omega) - Sintegrand4(nu, omega)
...
def M1cl(epsilon, omega, lambdaValue, phiValue, voltageValue, couplingValue, Tvalue):
    ...
    def Sintegrand(nu1, omega):
        ...
        Saux1 = GK(nu2)*GA(nu3)*gA(nu3) + GR(nu2)*GK(nu3)*gA(nu3) +\
                GR(nu2)*GR(nu3)*gK(nu3)
...
def M2cl(epsilon, omega, lambdaValue, phiValue, voltageValue, couplingValue, Tvalue):
    ...
    def Sintegrand(nu1, omega):
        ...
        Saux1 = gK(nu2)*GA(nu2)*GA(nu3) + gR(nu2)*GK(nu2)*GA(nu3) +\
                gR(nu2)*GR(nu2)*GK(nu3)
...
def K1q(epsilon, omega, lambdaValue, phiValue, voltageValue, couplingValue, Tvalue):
    ...
    gA = lambda omega: greenLeadsAdvanced(omega, couplingValue)
    gR = lambda omega: greenLeadsRetarded(omega, couplingValue)
    gK = lambda omega: greenLeadsKeldysh(omega, couplingValue, voltageValu, beta)
    ...
    def Sintegrand(nu1, omega):
        ...
        Saux1 = GA(nu2)*GK(nu3)*gA(nu3) + GA(nu2)*GR(nu3)*gK(nu3) +\
                GK(nu2)*GR(nu3)*gR(nu3)
...
def K2q(epsilon, omega, lambdaValue, phiValue, voltageValue, couplingValue, Tvalue):
    ...
    def Sintegrand(nu1, omega):
        ...
        Saux1 = gA(nu2)*GA(nu2)*GK(nu3) + gK(nu2)*GA(nu2)*GR(nu3) +\
                gR(nu2)*GK(nu2)*GR(nu3)
